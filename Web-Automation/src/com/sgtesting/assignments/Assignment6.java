...
public static WebDriver b=null;
	...
	private static void Createcustomer()
	{
		try {
			...
			Thread.sleep(2000);
			b.findElement(By.id("customerLightBox_nameField")).sendKeys("shivu");
			Thread.sleep(2000);
	...
	private static void CreateProject()
	{
		try {
			...
			Thread.sleep(2000);
			b.findElement(By.id("projectPopup_projectNameField")).sendKeys("agfvsv");
			Thread.sleep(2000);
			b.findElement(By.name("projectDescriptionField")).sendKeys("Iahaj");
			Thread.sleep(2000);
