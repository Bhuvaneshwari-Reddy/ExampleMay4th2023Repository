...
public class Assignment5 {
	...
	private static void Createcustomer()
	{
		try {
			...
			m.findElement(By.id("customerLightBox_nameField")).sendKeys("Shivu");
			m.findElement(By.xpath("//*[@id=\"customerLightBox_descriptionField\"]")).sendKeys("kshdfbcbjhfegugbh");
			Thread.sleep(1000);
			m.findElement(By.xpath("/html/body/div[8]/div/div/div[2]/table/tbody/tr/td[2]/div[1]/div/span")).click();
			Thread.sleep(2000);
	...
	private static void CreateProject()
	{
		try {
			...
			Thread.sleep(2000);
			m.findElement(By.id("projectPopup_projectNameField")).sendKeys("TumkurProject");
			Thread.sleep(2000);
			m.findElement(By.name("projectDescriptionField")).sendKeys("Water Resource Project");
			Thread.sleep(2000);
